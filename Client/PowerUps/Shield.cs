...
namespace Client.PowerUps {
    public class Shield : PowerUp {
        ...
        public override void Apply(Dictionary<string, object> parameters) {
            ...
            VFXNode vfx = new(TextureHolder.Get("Texture/Effect/Shield"), new Vector2(GameValues.TILE_SIZE * 1.1f, GameValues.TILE_SIZE), 6, 0.1f, isLooping: true, isInfinite: true) {
                Position = new Vector2(-0.1f * GameValues.TILE_SIZE, GameValues.TILE_SIZE),
            };
