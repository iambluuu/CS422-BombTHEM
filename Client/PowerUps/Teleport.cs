...
namespace Client.PowerUps {
    public class Teleport : PowerUp {
        public override void Apply(Dictionary<string, object> parameters) {
            ...
            AnimatedNode log = new(TextureHolder.Get("Texture/Item/Wood", new Rectangle(16, 0, 16, 16)), new Vector2(GameValues.TILE_SIZE * 0.8f, GameValues.TILE_SIZE * 0.8f)) {
            ...
            VFXNode smokeEffect = new(TextureHolder.Get("Texture/Effect/Smoke"), new Vector2(GameValues.TILE_SIZE, GameValues.TILE_SIZE), 6, 0.1f) {
            ...
            VFXNode landingEffect = new(TextureHolder.Get("Texture/Effect/SmokeCircular"), new Vector2(GameValues.TILE_SIZE * 1.2f, GameValues.TILE_SIZE), 8, 0.1f) {
