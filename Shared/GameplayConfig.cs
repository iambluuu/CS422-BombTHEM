namespace Shared {
    public static class GameplayConfig {
        ...
        public static int GameDuration { get; set; } = 120; // in seconds
        ...
        public static readonly Dictionary<PowerName, float> PowerUpDurations = new() {
            { PowerName.MoreBombs, 5000f },
            { PowerName.Shield, 5000f },
            { PowerName.Nuke, -1},
        };

        public static readonly Dictionary<PowerName, int> PowerUpQuantity = new() {
