...
namespace Server {
    public static class GameplayConfig {
        ...
        public static float PowerUpSpawnChance { get; set; } = 0.1f; // 10% chance to spawn a power-up
        public static float PowerUpExistDuration { get; set; } = 20f; // stays for 20 seconds before disappearing
    }
}